...
public class AssessmentsServiceTest {
    ...
    public void getNumberOfTriggerWordsTest() throws Exception {
        NoteBean note1 = new NoteBean("1", 1, LocalDate.now(), "Antibodies");
        NoteBean note2 = new NoteBean("2", 1, LocalDate.now(), "Reaction");
    ...
    void getAssessmentsLevelOfRisksMaleLessThan30TriggersNumber5M() throws Exception {
        ...
        NoteBean note1 = new NoteBean("1", 1, LocalDate.of(2023, 1, 10), "Height");
        NoteBean note2 = new NoteBean("2", 1, LocalDate.of(2023, 1, 10), "MicroAlbumin");
        NoteBean note3 = new NoteBean("3", 1, LocalDate.of(2023, 1, 10), "Weight");
        NoteBean note4 = new NoteBean("4", 1, LocalDate.of(2023, 1, 10), "Smoker");
        NoteBean note5 = new NoteBean("5", 1, LocalDate.of(2023, 1, 10), "Cholesterol");
        when(patientProxy.getByIdPatient(any(Integer.class))).thenReturn(Optional.of(patient1));
    ...
    void getAssessmentsLevelOfRisksFemaleLessThan30TriggersNumber7F() throws Exception {
        ...
        NoteBean note4 = new NoteBean("4", 1, LocalDate.of(2023, 1, 10), "Smoker");
        NoteBean note5 = new NoteBean("5", 1, LocalDate.of(2023, 1, 10), "Cholesterol");
        NoteBean note6 = new NoteBean("6", 1, LocalDate.of(2023, 1, 10), "Cholesterol");
        NoteBean note7 = new NoteBean("7", 1, LocalDate.of(2023, 1, 10), "Cholesterol");
        when(patientProxy.getByIdPatient(any(Integer.class))).thenReturn(Optional.of(patient1));
    ...
    void getAssessmentsLevelOfRisksFemaleGreaterThan30TriggersNumber8X() throws Exception {
        ...
        NoteBean note6 = new NoteBean("6", 1, LocalDate.of(2023, 1, 10), "Cholesterol");
        NoteBean note7 = new NoteBean("7", 1, LocalDate.of(2023, 1, 10), "Cholesterol");
        NoteBean note8 = new NoteBean("8", 1, LocalDate.of(2023, 1, 10), "Cholesterol");
        when(patientProxy.getByIdPatient(any(Integer.class))).thenReturn(Optional.of(patient1));
